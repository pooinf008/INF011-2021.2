...
import br.ifba.inf011.estrut.proxy.server.ClientDicionarioDescricoesCache;
...
public class Aplicacao {
	...
	public void run() throws InterruptedException {
		...
		DicionarioDescricoesIF geradorSimbolo = new ClientDicionarioDescricoesCache();
		double setpoint = 25;
		Ambiente ambiente = new Ambiente();
		Controlador controlador = new Controlador(setpoint, 0.75);
		Relatorio relatorio = new Relatorio(geradorSimbolo, setpoint);
